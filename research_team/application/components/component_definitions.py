...
Modularized from `research_team.application.components` so that component
...
if TYPE_CHECKING:
    from research_team.application.components.components import ComponentType, Note
...
def _cloze_text_has_a_blank(value: Any, path: str) -> list[Note]:
    from research_team.application.components.components import Note, text
...
def _duplicates(entries: Sequence[tuple[str, Any]], noun: str, keyed: str) -> list[Note]:
    ...
    """
    from research_team.application.components.components import Note
...
def build_registry() -> dict[str, ComponentType]:
    from research_team.application.components.components import (
        ComponentType,
        Spec,
        flag,
        integer_between,
