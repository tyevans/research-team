...
from research_team.application.shared.ports import SessionRepository, TurnExecutor
...
async def start_session_in_project(
    ...
    *,
    ...
    import research_team.application.session.session_service as _session_service
