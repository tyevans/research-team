...
if TYPE_CHECKING:
    from research_team.application.components import ComponentType, Note
...
def _cloze_text_has_a_blank(value: Any, path: str) -> list[Note]:
    from research_team.application.components import Note, text
...
def _duplicates(entries: Sequence[tuple[str, Any]], noun: str, keyed: str) -> list[Note]:
    ...
    """
    from research_team.application.components import Note
