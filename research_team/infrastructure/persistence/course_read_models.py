...
from research_team.curriculum.domain.course import CourseAbandoned, CourseRealized
from research_team.curriculum.domain.curation import CourseFeatured, CourseUnfeatured
