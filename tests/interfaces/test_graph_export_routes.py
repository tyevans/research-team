"""`/api/projects/{id}/export/graph`: graph export route tests.

What can only break here is the wiring -- which entities a scoped graph export
contains, and whether the refusals are refusals rather than quietly empty files.
The layout arithmetic and the three serialisations belong to
