"""The media document routes over a project's corpus.

Tests media upload, content-streaming with range requests, 410 handling,
media drop/restore, and patch routes.
"""
