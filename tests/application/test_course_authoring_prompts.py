"""Tests for course authoring prompt construction and template contracts.

Validates anchor capping, entity ID propagation, reasoning ordering,
component guide alignment, and phase-specific prompting constraints.
"""
