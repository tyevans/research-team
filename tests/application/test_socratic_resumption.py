...
**Every name from `research_team.dialogue.application.socratic` is imported inside the
...
class RecordingExecutor:
    ...
    async def frame(self, *, project_id, topic):
        from research_team.dialogue.application.socratic import SocraticFraming
    ...
    async def respond(
        ...
        from research_team.dialogue.application.socratic import SocraticPrompt
...
async def test_an_evicted_dialogue_resumes_on_the_same_stream(transcripts):
    ...
    """
    from research_team.dialogue.application.socratic import DialogueRegistry
