...
| [`research_team/interfaces/web/socratic.py`](file:///home/ty/workspace/research-team/research_team/interfaces/web/socratic.py) | 714 | **442** | **Sub-450 Achieved (-272 lines, -38%)**: Extracted request/response models (`Attempt`, `SocraticStart`, etc.), SSE note framing (`_socratic_frame`), and dialogue view projections (`_dialogue_view`) into [`socratic_views.py`](file:///home/ty/workspace/research-team/research_team/interfaces/web/socratic_views.py) (186 lines). |
| [`research_team/infrastructure/persistence/interaction_reader.py`](file:///home/ty/workspace/research-team/research_team/infrastructure/persistence/interaction_reader.py) | 701 | **519** | **Sub-520 Achieved (-182 lines, -26%)**: Extracted interaction metrics, distance algorithms, summary models, and page schemas into [`interaction_models.py`](file:///home/ty/workspace/research-team/research_team/infrastructure/persistence/interaction_models.py) (261 lines). |
