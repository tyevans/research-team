...
| :--- | :--- | :--- | :--- |
| [`research_team/composition.py`](file:///home/ty/workspace/research-team/research_team/composition.py) | 1,604 | **1,275** | **In Progress (-329 lines)**: Extracted session service wiring, media acquisition, supervisor roster, and project service factories into `service_wiring.py`. Next: extract projection runners and graph wiring. |
...
| [`research_team/interfaces/web/sources.py`](file:///home/ty/workspace/research-team/research_team/interfaces/web/sources.py) | 1,015 | **1,015** | Decompose into source document lifecycle (`source_documents.py`) and media streaming / upload sniffing (`source_media.py`). |
| [`research_team/wiring/application.py`](file:///home/ty/workspace/research-team/research_team/wiring/application.py) | 1,005 | **1,005** | Split application lifecycle management (`start`/`close`) from application state container dataclass. |
...
| [`research_team/interfaces/web/course_html.py`](file:///home/ty/workspace/research-team/research_team/interfaces/web/course_html.py) | 1,424 | **812** | **Complete (-612 lines)**: Decomposed into markdown parsing, navigation, and widget rendering. |
| [`research_team/interfaces/web/app.py`](file:///home/ty/workspace/research-team/research_team/interfaces/web/app.py) | 1,163 | **872** | **In Progress (-291 lines)**: Extracted domain route modules; remaining routes in progress. |
