 ...
 *
 * Each rail pane folds to its head, and remembers that across reloads. Three
 * regions sharing one column means none of them is tall enough to work in
 * while all three are open, and which one you need is a function of what you
 * are doing -- reading the queue, or reading your sources. Folding is what
 * gives the other panes the height, so it is a layout decision rather than a
 * convenience.
 *
  ...
  <section className="view view-research">
    ...
    <div className="research-workbench">
      <div className="research-rail">
        <RailPane name="seeding" title="Seeding" label="Seeding">
        ...
        <RailPane name="documents" title="Documents" label="Documents">
